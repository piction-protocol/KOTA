...
public class TransactionViewModelTest {
    ...
    public void findShouldBeSuccessful() throws Exception {
        ...
        Assert.assertArrayEquals(TransactionViewModel.find(tangle, Arrays.copyOf(hash.bytes(), Integer.parseInt(Configuration.Companion.getREQ_HASH_SIZE()))).getBytes(), transactionViewModel.getBytes());
    }
    ...
    public void findShouldReturnNull() throws Exception {
        ...
        Assert.assertFalse(Arrays.equals(TransactionViewModel.find(tangle, Arrays.copyOf(hash.bytes(), Integer.parseInt(Configuration.Companion.getREQ_HASH_SIZE()))).getBytes(), transactionViewModel.getBytes()));
    }
